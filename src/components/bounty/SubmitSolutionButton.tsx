    ...
    >
      <button
        ...
        style={{
          ...
          fontWeight: 600,
          color: "var(--text)",
          /* One flat action fill. The gradient ran --action into amber, and
             amber under a label is the one thing the theme rules out. */
          background: "var(--action)",
          border: "none",
          borderRadius: 6,
          padding: isStage ? "4px 10px" : "3px 8px",
          cursor: "pointer",
          boxShadow: "0 2px 8px color-mix(in srgb, var(--action) 30%, transparent)",
        }}
      >
        Submit a solution
      </button>
