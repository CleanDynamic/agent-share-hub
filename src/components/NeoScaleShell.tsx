    ...
    <div className="ns-root">
      ...
      <div className="ns-scale-wrapper">
        <div className="ns-app-container" ref={containerRef}>
          ...
          {/* ═══ LEFT PANEL ═══ */}
          <LiquidGlassPanel cornerRadius={20} elasticity={0.15} disableEffect style={{ width: 200, height: 775, flexShrink: 0 }}>
          <div
          ...
          {/* ═══ RIGHT PANEL ═══ */}
          <LiquidGlassPanel cornerRadius={20} elasticity={0.15} disableEffect style={{ width: 220, height: 775, flexShrink: 0 }}>
          <div
