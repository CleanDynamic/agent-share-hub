...
.ns-nav-divider { height: 1px; background: rgba(255,255,255,0.06); margin: 8px 4px; }
.ns-nav-badge {
  display: flex; align-items: center; justify-content: center;
      ...
      <div className="ns-scale-wrapper">
        <div className="ns-app-container" ref={containerRef}>
          ...
          <div
            ...
            {...initTilt(rightRef)}
          >
            {(location.pathname.startsWith('/upload/blueprint') || location.pathname.startsWith('/upload/blog')) ? (
              <WorkspaceShell />
            ) : (
            <>
