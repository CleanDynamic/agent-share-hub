...
export function RightPanelExplore() {
        ...
        {trending.map((item, i) => {
          ...
          return (
            <button
              ...
              className="glass-level-1 flex w-full items-center gap-3 rounded-2xl px-4 py-3 text-left transition-feedback border border-white/5"
            >
